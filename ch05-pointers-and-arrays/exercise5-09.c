 ...
 *      Thread model: posix
 *  Description: Rewrite the routines day_of_year and month_day with pointers instead 
 *  of indexing.
 * 
 * =====================================================================================
 */
...
static char row1[] = {0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
static char row2[] = {0, 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
static char *daytab[2] = {row1, row2};
